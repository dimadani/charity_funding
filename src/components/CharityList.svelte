<script>
    ...
    function calculatedFounded(pledged, target) {
    ...
    function dateDayRemaining(date_end) {
            ...
            <div class="xs-popular-item xs-box-shadow">
                ...
                <div class="xs-skill-bar">
                    ...
                    <p><span class="number-percentage-count number-percentage" data-value="90"
                        data-animation-duration="3500">{calculatedFounded(charity.pledged,charity.target)}</span>%</p>
                    </div>
                </div>
                ...
                <ul class="xs-list-with-content">
                    ...
                    <li><span class="number-percentage-count number-percentage" data-value="90"
                        data-animation-duration="3500">{calculatedFounded(charity.pledged,charity.target)}</span>% <span>Funded</span></li>
